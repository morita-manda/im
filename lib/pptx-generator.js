...
async function generateIM(data) {
  ...
  // ========== Slide 5: 会社概要サマリー ==========
  {
    ...
    const companyRowH = [0.42, 0.42, 0.58, 1.1, 0.42, 0.42, 0.42];
    let companyY = 2.15;
  ...
  // ========== Slide 7: 対象会社概要 ==========
  {
    ...
    // 設立（index 1）・本社住所（index 4）・事業内容（index 6）は長くなりがち
    const detailRowH = [0.42, 0.58, 0.42, 0.42, 0.58, 0.42, 1.2, 0.42];
    let detailY = 1.3;
